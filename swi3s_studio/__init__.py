...
#          variant; deferred with the recipe in docs/TECH_DEBT.md.
...
#          its spacing counter runs to −1); see docs/spacing_bug.md.
...
#        • Process: the perf/UI regression loop is formalised in docs/PERFORMANCE.md — the
...
#          scoped and deferred (docs/decode_multithreading.md).
#        • Performance pass (post-review, all output-preserving — see docs/PERF_REVIEW.md).
