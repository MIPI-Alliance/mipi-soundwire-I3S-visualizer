...
class FlowMode(IntEnum):
    ...
    RX_CONTROLLED = 2 # Rx Controlled - DRQ requests data; TxPresent carries a
                      #   copy of the FCP_DRQ from 1-2 Intervals earlier ({ASW5203})
...
class SlotType(Enum):
    ...
    EMPTY    = -1 # Position not owned by any DataPort (returned when inactive)
