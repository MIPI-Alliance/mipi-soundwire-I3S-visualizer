"""Analyzer ▸ Open Visualizer Config dialog.
...
from PySide6.QtWidgets import (QButtonGroup, QDialog, QDialogButtonBox, QFileDialog,
...
class OpenVisualizerConfigDialog(QDialog):
    ...
    def __init__(self, parent, *, has_authoring: bool, start_dir: str = "") -> None:
        ...
        self.setWindowTitle("Open Visualizer Config")
        ...
        self._from_auth = QRadioButton("From current Visualizer authoring")
