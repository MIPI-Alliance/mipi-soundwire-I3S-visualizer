...
Run: PYTHONPATH=. python3 tests/test_validators.py
"""
import os
...
if __name__ == "__main__":
    test_fcp_fits_row_is_direction_aware(); print("ok: FCP row-fit counts guard/tail only for a sink DP")
    test_wide_bit_straddle_uses_partial_trailing_group(); print("ok: wide-bit straddle sizes the partial trailing group")
    test_engine_builds_partial_and_oversized_channel_groups(); print("ok: engine builds partial/oversized channel groups without IndexError")
