...
Run: QT_QPA_PLATFORM=offscreen PYTHONPATH=. python3 tests/test_export.py
"""
import csv
import os
import tempfile
...
if __name__ == "__main__":
    test_commands_csv(); print("ok: command CSV export")
    test_grid_export_png_svg(); print("ok: bus-grid PNG + SVG export")
