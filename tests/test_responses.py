...
Run: python3 tests/test_responses.py
"""
from swi3s_studio.analysis.responses import (peripheral_response_name,
                                             manager_response_name, response_summary)
...
if __name__ == "__main__":
    test_peripheral_names_by_phase(); print("ok: peripheral response names by phase")
    test_manager_names_by_phase(); print("ok: manager response names by phase")
    test_response_summary(); print("ok: response summary (write/commit/ping)")
    test_commit_peripheral_response_decoded(); print("ok: SSCR peripheral response surfaced")
