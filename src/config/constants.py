...
class CSVFields:
    ...
    # Legacy aliases for backward compatibility (deprecated, use new names above)
    COLUMNS_PER_ROW = NUM_COLUMNS_REG
    SKIPPING_DENOMINATOR = SKIPPING_DENOMINATOR_REG
    S1_TAIL_WIDTH = S1_TAIL_WIDTH_REG
    TAIL_WIDTH = S1_TAIL_WIDTH_REG  # Legacy alias
    DRAW_S1_HANDOVER = ENFORCE_S1_HANDOVER
    CDS_WIDTH = CDS_BIT_WIDTH_REG
    CDS_GUARD_ENABLED = CDS_GUARD_ENABLED_REG
    CDS_TAIL_WIDTH = CDS_TAIL_WIDTH_REG
    DRAW_CDS_HANDOVER = ENFORCE_CDS_HANDOVER
    DP_CHANNELS = DP_NUM_CHANNELS
    DP_CHANNEL_GROUPING = DP_CHANNEL_GROUPING_REG
    DP_CHANNEL_GROUP_SPACING = DP_SPACING_REG
    DP_SAMPLE_SIZE = DP_SAMPLE_SIZE_REG
    DP_SAMPLE_GROUPING = DP_SAMPLE_GROUPING_REG
    DP_INTERVAL = DP_INTERVAL_REG
    DP_SKIPPING_NUMERATOR = DP_SKIPPING_NUMERATOR_REG
    DP_OFFSET = DP_OFFSET_REG
    DP_HORIZONTAL_START = DP_HORIZONTAL_START_REG
    DP_HORIZONTAL_COUNT = DP_HORIZONTAL_COUNT_REG
    DP_TAIL_WIDTH = DP_TAIL_WIDTH_REG
    DP_BIT_WIDTH = DP_BIT_WIDTH_REG
    DP_IS_SOURCE = DP_PORT_DIRECTION_REG
    DP_DRAW_HANDOVER = DP_ENFORCE_HANDOVER
    DP_GUARD_ENABLED = DP_GUARD_ENABLE_REG
    DP_SRI = DP_SUB_ROW_INTERVAL_REG
    DP_DEVICE_NUMBER = DP_DEVICE_NUMBER_REG  # Legacy alias
