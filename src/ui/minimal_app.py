...
class MinimalApp(ctk.CTkFrame):
    ...
    def _on_flow_mode_checkbox_click(self, dp_index: int) -> None:
        ...
        dialog = FlowModeSelectorDialog(
            ...
            dp_index=dp_index,
            fcp_h_start=data_port.config.FCP_HorizontalStart_REG,
            fcp_bit_width=data_port.config.FCP_BitWidth_REG,
            fcp_tail_width=data_port.config.FCP_TailWidth_REG,
            fcp_offset=data_port.config.FCP_Offset_REG,
            fcp_guard_enable=data_port.config.FCP_GuardEnable_REG,
            fcp_guard_polarity=data_port.config.FCP_GuardPolarity_REG
        )
        ...
        if not dialog.cancelled:
            ...
            data_port.config.FCP_HorizontalStart_REG = dialog.fcp_h_start
            data_port.config.FCP_BitWidth_REG = dialog.fcp_bit_width
            data_port.config.FCP_TailWidth_REG = dialog.fcp_tail_width
            data_port.config.FCP_Offset_REG = dialog.fcp_offset
            data_port.config.FCP_GuardEnable_REG = dialog.fcp_guard_enable
            data_port.config.FCP_GuardPolarity_REG = bool(dialog.fcp_guard_polarity)
    ...
    def _reset_all_to_zero(self) -> None:
        ...
        for dp_index, dp in enumerate(self.interface.data_ports):
            ...
            dp.config.FCP_HorizontalStart_REG = 0
            dp.config.FCP_BitWidth_REG = 0
            dp.config.FCP_TailWidth_REG = 0
            dp.config.FCP_Offset_REG = 0
            dp.config.FCP_GuardEnable_REG = False
            dp.config.FCP_GuardPolarity_REG = False
